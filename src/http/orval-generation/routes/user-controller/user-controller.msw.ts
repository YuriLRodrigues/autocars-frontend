...
export const getFindAllTopSellersResponseMock = (): FindAllTopSellersResponseDto[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.alpha(20), profileImg: faker.string.alpha(20), name: faker.string.alpha(20), amountSold: faker.number.int({min: undefined, max: undefined}), quantitySold: faker.number.int({min: undefined, max: undefined})})))
