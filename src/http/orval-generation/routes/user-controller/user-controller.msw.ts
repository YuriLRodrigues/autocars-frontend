...
export const getBlockUserResponseMock = (
  overrideResponse: Partial<BlockUserResponseDto> = {},
): BlockUserResponseDto => ({ message: faker.string.alpha(20), ...overrideResponse })
...
export const getFindAllTopSellersResponseMock = (
  overrideResponse: Partial<FindAllTopSellersResponseDto> = {},
): FindAllTopSellersResponseDto => ({ message: faker.string.alpha(20), ...overrideResponse })
...
): UpdateOwnUserResponseDto => ({ message: faker.string.alpha(20), ...overrideResponse })

export const getBlockUserMockHandler = (
  overrideResponse?:
    | BlockUserResponseDto
    | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<BlockUserResponseDto> | BlockUserResponseDto),
) => {
  return http.patch('*/user/block/:id', async (info) => {
    await delay(1000)
